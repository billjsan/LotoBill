...
public class UI {
     ...
     * @param vector
     */
    public static void  show(ArrayList<Integer> vector){
     ...
     * @param message
     */
    public static void  show(Integer[] vector, String message){
     ...
     * @return
     */
    private static String formatTextForUI(ArrayList<String> list){
